<template>
  ...
  >
    ...
    >
      ...
      <ChevronDownIcon class="arrow" :class="{ rotate: dropdownVisible }" />
    </div>
...
const field = props.field
  ? useField(props.name, undefined, {
      initialValue: (props.modelValue || props.defaultValue)?.value
    })
  : undefined;
...
watch(selectedValue, (value) => {
  if (props.field) {
    if (props.field instanceof Function) {
      field.handleChange(props.field(value), true);
    } else {
...
.animated-dropdown {
  ...
  .selected {
    ...
    background-color: var(--mp-c-bg-alt);
  ...
  .options {
    ...
    .option {
      background-color: var(--mp-c-bg-soft);
      display: flex;
      align-items: center;
